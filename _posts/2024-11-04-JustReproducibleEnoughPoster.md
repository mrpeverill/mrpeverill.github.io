...
* Generate a [https://github.com/mrpeverill/ABCD-rsFMRI-QCandMissingness/blob/main/Flux/PosterRmdTemplate.docx](word template). When rmarkdown generates your document, it will use the styles and page layout in this file to format it. So the template has:
...
* Next, an [https://github.com/mrpeverill/ABCD-rsFMRI-QCandMissingness/blob/main/Flux/PosterText.Rmd](Rmarkdown) file should generate all of the column text, tables, and column figures.
...
The key here is that the important parts of the poster -- tables and figures -- are reproducible, but you retain control over the design of the poster. As a bonus, because everything is generated by rmarkdown and saved as pdfs with a defined size, font sizes will be preserved across elements of your poster. This worked really well for me, and didn't take a ton of extra time. Let me know how this works for you!
